...
class Meditation2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.meditation2, container, false)

        db = UserDatabase.getDatabase(requireContext())

        val title = arguments?.getString("title") ?: "Deep Sleep"
        val description = arguments?.getString("description") ?: "Relax completely and enjoy a deep sleep."

        val tvTitle = view.findViewById<TextView>(R.id.tvTitle2)
        val tvDescription = view.findViewById<TextView>(R.id.tvDescription)
        val btnAddFavorites = view.findViewById<Button>(R.id.btnAddFavorites2)
