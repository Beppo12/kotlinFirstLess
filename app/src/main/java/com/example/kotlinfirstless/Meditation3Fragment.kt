...
class Meditation3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.meditation3, container, false)

        db = UserDatabase.getDatabase(requireContext())

        val title = arguments?.getString("title") ?: "Mindfulness"
        val description = arguments?.getString("description") ?: "Focus on your breathing and stay present."

        val tvTitle = view.findViewById<TextView>(R.id.tvTitle3)
        val tvDescription = view.findViewById<TextView>(R.id.tvDescription)
        val btnAddFavorites = view.findViewById<Button>(R.id.btnAddFavorites3)
