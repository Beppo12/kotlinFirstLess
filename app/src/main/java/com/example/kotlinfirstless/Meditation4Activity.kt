...
class Meditation4Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.meditation4, container, false)

        db = UserDatabase.getDatabase(requireContext())

        val title = arguments?.getString("title") ?: "Deep Relax"
        val description = arguments?.getString("description") ?: "Release tension and fully relax your body."

        val tvTitle = view.findViewById<TextView>(R.id.tvTitle4)
        val tvDescription = view.findViewById<TextView>(R.id.tvDescription)
        val btnAddFavorites = view.findViewById<Button>(R.id.btnAddFavorites4)
